...
- additional conserved quantity diagnostics
- more accurate periodic orbit solvers
- trajectory design interfaces for transfers and rendezvous
- command-line configuration for initial conditions and plot options
